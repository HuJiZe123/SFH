...
{
    public class tbl_ConstantValuesController : Controller
    {
        ...
        // GET: tbl_ConstantValues
        public ActionResult Index()
        {

            var ConstantValues = db.tbl_ConstantValues.Where(cv => cv.status == 1).ToList();
            return View(ConstantValues);
        }
        // GET: tbl_ConstantValues/Details/5
        public ActionResult Details(int? id)
        {
            ...
            tbl_ConstantValues tbl_ConstantValues = db.tbl_ConstantValues.Find(id);
            if (tbl_ConstantValues == null)
            {
                return HttpNotFound();
            }
            return View(tbl_ConstantValues);
        }

        // GET: tbl_ConstantValues/Create
        ...
        // POST: tbl_ConstantValues/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "id,Description,Value")] tbl_ConstantValues tbl_ConstantValues)
        {
            try
            {
                tbl_ConstantValues.status = 1;
                if (ModelState.IsValid)
                {
                    db.tbl_ConstantValues.Add(tbl_ConstantValues);
                    db.SaveChanges();
        ...
        // POST: tbl_ConstantValues/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Description,Value,status")] tbl_ConstantValues tbl_ConstantValues)
        {
            try
            {
                tbl_ConstantValues.status = 1;
                if (ModelState.IsValid)
                {
                    db.Entry(tbl_ConstantValues).State = EntityState.Modified;
                    db.SaveChanges();
                    return RedirectToAction("Index");
                }
                return View(tbl_ConstantValues);
        ...
        // GET: tbl_ConstantValues/Delete/5
        ...
        // POST: tbl_ConstantValues/Delete/5
